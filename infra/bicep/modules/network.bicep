...
resource appServiceVnetIntegSubnet 'Microsoft.Network/virtualNetworks/subnets@2021-05-01' = {
  parent: vnet
  name: 'fujitsu-sbn-app-service-vnet-integ-6j8b0'
  properties: {
...
output appServiceVnetIntegSubnetId string = appServiceVnetIntegSubnet.id
